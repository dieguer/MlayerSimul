...
ploto %>%ggplot( ) + 
  geom_histogram(aes( x=value...3, fill=variable...2))
 


ploto %>%ggplot( ) + 
  geom_histogram(aes( x=value...6, fill=variable...2))


ploto %>%ggplot( ) + 
  geom_histogram(aes( x=value...9, fill=variable...2))
...
testo=plots=lapply(sample.int(200, 9), function(x){
